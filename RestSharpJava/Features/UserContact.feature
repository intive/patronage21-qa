...
#Link to Zephyr
Scenario: USER_CONTACT_2_Contact_with_other_users_by_correct_phone_available_in_the_user_account
...
#Link to Zephyr
Scenario: USER_CONTACT_3_Access_to_github_repository_via_correct_link_available_in_the_user_account
