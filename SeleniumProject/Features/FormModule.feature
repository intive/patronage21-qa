...
#zephyr link
Scenario: FORM_MODULE_1_IP2-180_form_with_required_data
...
#zephyr link 
Scenario: FORM_MODULE_8_IP2-180_form_filled_with_checked_all_fields:_'JavaScript,Java,QA,Mobile'
	Given User fills required data 
...
#zephyr link 
Scenario: FORM_MODULE_9_IP2-180_form_with_checked_three_fields:_'JavaScript,Java,QA,Mobile'
	Given User fills required data 
...
#zephyr link 
Scenario: FORM_MODULE_10_IP2-180_form_with_incorrect_field_'Powtórz hasło'
	Given User fills required data 
...
#zephyr link 
Scenario: FORM_MODULE_11_IP2-180_form_with_incorrect_password_which_is_too_short
	Given User fills required data 
...
#zephyr link 
Scenario: FORM_MODULE_12_IP2-180_form_with_incorrect_password_which_doesn't_have_one_uppercase
	Given User fills password field without minimum one uppercase
	When User clicks on the button Załóż konto
	Then User should see message about missing one uppercase

#zephyr link
Scenario: FORM_MODULE_13_IP2-180_form_with_incorrect_password_which_doesn't_have_one_special_key
...
#zephyr link
Scenario: FORM_MODULE_14_IP2-180_form_without_checked_field_'Regulamin'
	Given User fills required data 
	When Users doesn't check field Regulamin
	Then The button should be inactive

#zephyr link
Scenario: FORM_MODULE_15_IP2-180_form_with_incorrect_field_'Github link'
	Given User fills field with random letters
	When User clicks on the button Załóż konto
	Then User should see error message about incorrect Github link

#zephyr link
Scenario: FORM_MODULE_16_IP2-180_form_with_too_short_'Login'
	Given User fills too short login
	When User clicks on the button Załóż konto
	Then User should see error message about incorrect Login

#zephyr link
Scenario: FORM_MODULE_17_IP2-180_form_with_too_long_'Login'
