...
Scenario: CALENDAR_1_IP2-543_Present_day_is_highlighted
Then Present day is highlighted

@ignore
# https://tracker.intive.com/jira/browse/IP2-729
Scenario: CALENDAR_2_IP2-543_Every_date_can_be_highlighted
When User clicks on randomly picked date
Then date is highlighted

@ignore
#https://tracker.intive.com/jira/browse/IP2-730
Scenario: CALENDAR_3_IP2-543_Months_can_be_changed 
