...
Scenario: USER_LIST_[/api/list]_[GET]_1_IP2-294_List_of_all_user_is_visible
When Client sends request to API
Then Response is successful
And contains list of all users

#https://tracker.intive.com/jira/browse/IP2-566
Scenario: USER_LIST_[/api/list]_[GET]_2_IP2-294_List_of_active_users_is_visible
