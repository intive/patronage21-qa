...
namespace RestSharpProject.Steps
{
    ...
    public class RegistrationFormSteps
    {
        ...
        public void GivenUserFilledAllData()
        {
            ...
            user = new User(null, null, null, null, null, technologies, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, 0, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User("userEnteredTooLongUserFirstName", null, null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, "userEnteredTooLongUserLastNamee", null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, 1234567890, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, null, null, null, "tooLongExampleLogin", null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User("J", null, null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, "K", null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, 12345678, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, null, null, "password", null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, null, null, null, null, null, null, null, "wrongLink");
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User("QŃ", "Kędzierzawy", null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
        ...
        {
            user = new User(null, "Kowalski-Nowak", null, null, null, null, null, null, null);
            user = user.CreateUser(user);
        }
