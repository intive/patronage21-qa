...
Scenario: REGISTRATION_PAGE_1_[/api/projects]_[POST]_IP2-88_User_registration_after_correctly_filling_in_the_form 
...
Scenario Outline: REGISTRATION_PAGE_2_[/api/projects]_[POST]_IP2-88_User_registration_without_filling_in_all_data  
...
Scenario Outline: REGISTRATION_PAGE_3_[/api/projects]_[POST]_IP2-88_User_registration_after_entering_data_incorrectly
...
Scenario: REGISTRATION_PAGE_4_[/api/projects]_[POST]_IP2-88_User_registration_that_already_exists 
Given User completes form correctly
