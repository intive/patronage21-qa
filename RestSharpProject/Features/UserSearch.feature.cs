...
#line hidden
#line 8
testRunner.And("Customer sets the endpoint with method GET", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
        }
        ...
        [NUnit.Framework.DescriptionAttribute("USER_SEARCH_[/api/users]_[GET]_1_IP2-90_Searching_for_the_existing_user_by name_s" +
            "urname_or_username")]
        [NUnit.Framework.TestCaseAttribute("?userName=TomNowak", "\"userName\": \"TomNowak\"", null)]
        [NUnit.Framework.TestCaseAttribute("?firstName=Tomasz", "\"firstName\": \"Tomasz\"", null)]
        [NUnit.Framework.TestCaseAttribute("?lastName=Nowak", "\"lastName\": \"Nowak\"", null)]
        public virtual void USER_SEARCH_ApiUsers_GET_1_IP2_90_Searching_For_The_Existing_User_ByName_Surname_Or_Username(string query, string body, string[] exampleTags)
        {
...
#line hidden
#line 13
testRunner.And(string.Format("Customer enters valid {0}", query), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 14
...
#line hidden
#line 16
testRunner.And(string.Format("JSON body contains {0}", body), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
...
#line hidden
#line 26
testRunner.Given("User with first name \"Tomasz\" and last name \"Nowak\" exists in application", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 27
testRunner.And("Customer enters \"?firstName=Tomasz&lastName=Nowak\" as a query", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 28
testRunner.When("Customer sends the request to the endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
#line 30
testRunner.And("JSON body contains <\"firstName\": \"Tomasz\"> and <\"lastName\": \"Nowak\">", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
#line 36
testRunner.And("Customer enters \"?firstName=Tomasz&lastNNNName=Nowak\" as a query", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 37
testRunner.When("Customer sends the request to the endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
#line 39
testRunner.And("JSON body contains <\"firstName\": \"Tomasz\">", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
#line 45
testRunner.And("Customer enters \"?firsdNName=Tomasz&lastName=Nowak\" as a query", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 46
testRunner.When("Customer sends the request to the endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
#line 48
testRunner.And("Error message is shown", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        public virtual void USER_SEARCH_ApiUsers_GET_5_IP2_90_Searching_For_The_Non_Existing_User(string searchData, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
...
#line hidden
#line 54
testRunner.And(string.Format("Customer enters invalid {0} as a query", searchData), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 55
testRunner.When("Customer sends the request to the endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        public virtual void USER_SEARCH_ApiUsers_GET_6_IP2_90_Sending_Request_With_No_Value_In_Query(string key, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
...
#line hidden
#line 68
testRunner.And(string.Format("Customer enters valid {0} as the query parameter", key), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 69
