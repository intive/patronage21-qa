...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Jan Kowalski", "Uczestnicy", null)]
        [NUnit.Framework.TestCaseAttribute("Anna Nowak", "Liderzy", null)]
        public virtual void USERS_SCREEN_16_IP2_152_User_Own_Account_Is_Marked(string name, string list, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("name", name);
...
#line hidden
#line 186
 testRunner.And(string.Format("No other user in list \"{0}\" is named \"<user>\"", list), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 187
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Anna Nowak", "Liderzy", "Uczestnicy", null)]
        public virtual void USERS_SCREEN_17_IP2_152_User_Own_Account_Is_Marked_And_Other_User_With_The_Same_Name_Is_Not_Marked(string name, string list1, string list2, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("name", name);
...
#line hidden
#line 198
 testRunner.And(string.Format("Existing user \"{0}\" assigned to \"{1}\" list", name, list1), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 199
 testRunner.And(string.Format("Existing user \"{0}\" assigned to \"{1}\" list", name, list2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 200
 testRunner.Then(string.Format("User sees \"Ty\" mark next to user \"{0}\" in \"{1}\" list", name, list1), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 201
