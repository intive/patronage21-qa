...
# zephyr link
Scenario: TECH_GROUPS_SCREEN_3_IP2-251_tech_groups_from_api_displayed_correctly
	Then User sees correct tech groups

# zephyr link
Scenario Outline: TECH_GROUPS_SCREEN_4_IP2-251_filter_groups
	When User clicks "Wybierz grupę"
...
# zephyr link
Scenario Outline: TECH_GROUPS_SCREEN_5_IP2-251_navigate_to_and_back
